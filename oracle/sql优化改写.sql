...
-- 12.1
select EMPNO,ENAME,MGR ,(prior ENAME) as mgrname from EMP start with EMPNO= 7566 connect by  (prior EMPNO) = MGR;

select EMPNO, ENAME, MGR, (prior ENAME) as mgrname, level 等级, CONNECT_BY_ISLEAF 叶子节点
from EMP
start with EMPNO = 7566
connect by (prior EMPNO) = MGR;

-- 12.3
-- TODO connect_by_root ?
select EMPNO, ENAME, MGR, sys_connect_by_path(ENAME, ',') 路径
from EMP
start with EMPNO = 7566
connect by (prior EMPNO) = MGR;
